...
var LiveMessagingManager = function ()
{
    return {
        ...
        init: function ()
        {
            ...
            this.visibile_ora = $("#lista_inarrivo_ig");
        ...
        impostaInterfacciaScrittura: function ( )
        {
            if( typeof $("#destinatario").data('ui-autocomplete') === "undefined" )
            {
                $("#destinatario").autocomplete({
                    ...
                    source : this.recuperaDestinatariAutofill.bind(this,"ig")
                });
        ...
        {
            return parseInt( row.letto_messaggio, 10 ) === 0 ? " "+data+" " : data;
        },
